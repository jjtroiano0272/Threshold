...
//     //Reference to Character script which contains the value if the player is facing left or right; if 
//     // you don't have this or it's named something different, either omit it or change the class name 
//     // to what your Character script is called
...
//     private void Start()
//     {
//         //Reference to the Character script on the player; if you don't have this or it's named something 
//         // different, either omit it or change the class name to what your Character script is called
//         character = GetComponentInParent<PlayerAnimator>();
//         //Reference to the Rigidbody2D on the player
