...
// public class MeleeAttackManager : PlayerAnimator
// {
...
//     //Start method from the Character script; grabs all the references the script has and adds some; if you don't inherit from
//     //  a parent Character script, delete or comment out this method and use Start instead
