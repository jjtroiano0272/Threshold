...
public class PlayerControllerNew : MonoBehaviour
{
    ...
    [SerializeField]
    private Transform m_WallCheck; //Posicion que controla si el personaje toca una pared
            ...
            else if (m_IsWall && !m_Grounded)
            {
                ...
                if (jump && isWallSliding)
                {
                    ...
                    m_Rigidbody2D.AddForce(
                        new Vector2(transform.localScale.x * m_JumpForce * 1.2f, m_JumpForce)
                    );
